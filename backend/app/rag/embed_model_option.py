...
admin_embed_model_options: List[EmbeddingModelOption] = [
    ...
    EmbeddingModelOption(
        ...
        provider_url= "https://api.chatanywhere.tech/v1",
        provider_description="SunDB.AI's local embedding server, deployed on your own infrastructure and powered by sentence-transformers.",
        default_embedding_model="text-embedding-ada-002",
        embedding_model_description="Find more models in huggingface.",
        default_config={
            "api_url": "https://api.chatanywhere.tech/v1/embeddings",
        },
        config_description="api_url is the url of the sundb ai local embedding server.",
        credentials_display_name="Local Embedding API Key",
        credentials_description="Local Embedding server require an API key,.",
        credentials_type="str",
        default_credentials="dummy",
    ),
    EmbeddingModelOption(
